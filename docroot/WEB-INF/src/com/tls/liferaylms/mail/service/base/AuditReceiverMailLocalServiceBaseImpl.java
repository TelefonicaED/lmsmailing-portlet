...
/**
 * The base implementation of the audit receiver mail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.tls.liferaylms.mail.service.impl.AuditReceiverMailLocalServiceImpl}.
 * </p>
 *
 * @author je03042
 ...
 * @generated
 */
public abstract class AuditReceiverMailLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AuditReceiverMailLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.tls.liferaylms.mail.service.AuditReceiverMailLocalServiceUtil} to access the audit receiver mail local service.
	 */
	...
	public AuditReceiverMail addAuditReceiverMail(
		AuditReceiverMail auditReceiverMail) throws SystemException {
		auditReceiverMail.setNew(true);

		return auditReceiverMailPersistence.update(auditReceiverMail, false);
	}
	 ...
	 */
	public AuditReceiverMail createAuditReceiverMail(long auditReceiverMailId) {
		return auditReceiverMailPersistence.create(auditReceiverMailId);
	}
	...
	public AuditReceiverMail deleteAuditReceiverMail(long auditReceiverMailId)
		throws PortalException, SystemException {
		return auditReceiverMailPersistence.remove(auditReceiverMailId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AuditReceiverMail deleteAuditReceiverMail(
		AuditReceiverMail auditReceiverMail) throws SystemException {
		return auditReceiverMailPersistence.remove(auditReceiverMail);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AuditReceiverMail.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return auditReceiverMailPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return auditReceiverMailPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AuditReceiverMail fetchAuditReceiverMail(long auditReceiverMailId)
		throws SystemException {
		return auditReceiverMailPersistence.fetchByPrimaryKey(auditReceiverMailId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AuditReceiverMail getAuditReceiverMail(long auditReceiverMailId)
		throws PortalException, SystemException {
		return auditReceiverMailPersistence.findByPrimaryKey(auditReceiverMailId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return auditReceiverMailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AuditReceiverMail> getAuditReceiverMails(int start, int end)
		throws SystemException {
		return auditReceiverMailPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAuditReceiverMailsCount() throws SystemException {
		return auditReceiverMailPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AuditReceiverMail updateAuditReceiverMail(
		AuditReceiverMail auditReceiverMail) throws SystemException {
		return updateAuditReceiverMail(auditReceiverMail, true);
	}
	...
	public AuditReceiverMail updateAuditReceiverMail(
		...
		return auditReceiverMailPersistence.update(auditReceiverMail, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.tls.liferaylms.mail.model.AuditReceiverMail",
			auditReceiverMailLocalService);
	}
	...
	private AuditReceiverMailLocalServiceClpInvoker _clpInvoker = new AuditReceiverMailLocalServiceClpInvoker();
}