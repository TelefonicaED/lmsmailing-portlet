...
if (window.jQuery)(function ($) {
	...
	$.fn.MultiFile = function (options) {
		...
		this
			...
			.each(function () {
				...
				o.maxfile = $('#maxFile').val();
				o.maxsize = $('#maxFile').val();
				...
				//console.log("E.NAME "+MultiFile.e.name);
				//===
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		maxfile: $('#maxFile').val(), // maximum size of a single file
		maxsize: $('#maxFile').val(), // maximum size of entire payload
		...
		STRING: {
			remove: 'x',
			denied: Liferay.Language.get('announcements.attachment.file-denied'),
			file: '$file',
			selected: Liferay.Language.get('announcements.attachment.file-selected')+ ' $file',
			duplicate: Liferay.Language.get('announcements.attachment.file-duplicated')+'\n$file',
			toomuch: Liferay.Language.get('announcements.attachment.file-limit-exceeded')+' ($size)',
			toomany:  Liferay.Language.get('announcements.attachment.too-much-files')+' ($max)',
			toobig: Liferay.Language.get('announcements.attachment.file-too-big')+' ($size)\n$file'
		},
	...
	$.fn.MultiFile.options.maxfile = $('#maxFile').val();
	$.fn.MultiFile.options.maxSize = $('#maxFile').val();
	//console.log($('#maxFile').val());
